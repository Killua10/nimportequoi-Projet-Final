...
<?php
    ...
    if($oBD->tableExiste($strNomTableUtilisateurs) == false){
        ...
        $oBD->insereEnregistrement($strNomTableUtilisateurs,16,"admin@nq.com",password_hash('admin', PASSWORD_DEFAULT), "2017-04-26", "11", "1", "901", "Nom", "Prenom", "N (514) 123-1234", "N (514) 123-1234 #9999", "N (514) 123-1234", "2017-04-26", "Admin");
    }
